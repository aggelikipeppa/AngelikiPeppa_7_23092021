                    ...
                    <footer >
                        ...
                        <div className="comments--likes">
                            <div className="likes--left">
                                <button disabled={likeActionloading} onClick={this.userLikeOrUnLikePost} className={ this.alreadyLiked() ? 'alreadyLiked' : ''} aria-label="like la publication">
